...
function build_lib {
	...
	cd ../ && \
	cd device && \
	gcc $1 -c dht22.c -D_REENTRANT $DEBUG_PARAM -pthread && \
	cd ../ && \
	cd acp && \
	...
	rm -f libpac.a
	ar -crv libpac.a app.o crc.o gpio.o timef.o $SOCK.o util.o tsv.o lcorrection.o 1w.o filter/ma.o filter/exp.o filter/common.o device/dht22.o acp/main.o && echo "library: done" && echo "hardware: $CPU $PINOUT"
	rm -f *.o acp/*.o
}
function build {
	cd lib && \
